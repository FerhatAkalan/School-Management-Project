<%@ Page Title="" Language="C#" MasterPageFile="~/Personel.Master" AutoEventWireup="true" CodeBehind="PersonelOgrenciEkle.aspx.cs" Inherits="OkulOtomasyonu.PersonelOgrenciEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="form-row">
        <div class="form-group col-md-5">
            <asp:Label for="TextOgrenciCinsiyet" runat="server">Öğrenci Cinsiyet</asp:Label>
            <asp:DropDownList ID="TextOgrenciCinsiyet" runat="server" CssClass="form-control">
                <asp:ListItem Value="0">Cinsiyet Seçiniz</asp:ListItem>
                <asp:ListItem>E</asp:ListItem>
                <asp:ListItem>K</asp:ListItem>
            </asp:DropDownList>
        </div>
        <div class="form-group col-md-1">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" InitialValue="0" ControlToValidate="TextOgrenciCinsiyet" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
        </div>
        <div class="form-group col-md-5">
        ...
        <div class="form-group col-md-1">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" InitialValue="0" ControlToValidate="TextOgrenciSinif" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-5">
            ...
            <asp:DropDownList ID="drpDanisman" runat="server" CssClass="form-control"></asp:DropDownList>
        </div>
        <div class="form-group col-md-1">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="drpDanisman" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
        </div>
        <div class="form-group col-md-5">
        ...
        <div class="form-group col-md-1">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="TextOgrenciSifre" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
        </div>
    </div>
    
    <div class="form-group col-md-12">
        <div>
            <asp:Button runat="server" Text="Kaydet" CssClass="btn btn-info" OnClick="Unnamed11_Click" />
        </div>
        <div>
