<%@ Page Title="" Language="C#" MasterPageFile="~/Danisman.Master" AutoEventWireup="true" CodeBehind="DanismanOgrenciNotEkle.aspx.cs" Inherits="OkulOtomasyonu.DanismanOgrenciNotEkle" %>
    ...
    <div class="form-group col-md-12">
        ...
        <div class="form-row col-md-13">
            ...
            <div class="form-group col-md-3">
                <asp:Label for="TextNotId" runat="server">Not ID</asp:Label>
                <asp:TextBox ID="TextNotId" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
            </div>
        </div>
        <div>
            <div class="form-group col-md-12">
